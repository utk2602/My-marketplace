...
const perks = [
  ...
  },
  {
    name: "For the Planet",
    Icon: Leaf,
    description: "We have pledge 1% of sales to the preservation and restoration of nature and environment."
  },
]
...
export default function Home() {
  ...
  <><MaxWidthWrapper>
    ...
    <div className='py-20 mx-auto text-center flex flex-col items-center max-w-3xl'>
      ...
      <p className='mt-6 text-lg max-w-prose text-muted-foreground'>Welcome to DigitalHippo.Every asset on our 
        platform is verified by our team to ensure our highest quality standards.
         </p>
  ...
  <section
    ...
    <MaxWidthWrapper className='py-20' >
      <div className='grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-6lg:grid-cols-3 lg:gap-x-8 lg:gap-y-0'>
        {perks.map((perk)=> (
